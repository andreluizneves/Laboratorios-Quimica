        ...
        if($request['nome'] == "" || $request['quantidade'] == "" ||  $request['descricao'] == "" || $request['laboratorio'] == "") {
            ...
            if(move_uploaded_file($nomeTemporario, '../' . $destino)){
                ...
                if($extensao == "jpeg" || $extensao == "JPEG" || $extensao == "jpg" || $extensao == "JPG" || $extensao == "png" || $extensao == "PNG" ){
                    ...
                    $sql = "INSERT INTO vidrarias (nome, quantidade, descricao, foto, id_lab) VALUES ('$request[nome]', $request[quantidade], '$request[descricao]', '../{$destino}', $lab)";
            ...
            if($resultado){
                $dados = array(
                    'icone' => 'success',
                    'msg' => 'Vidraria catalogada com êxito'
                );
            }else{
                $dados = array(
                    'icone' => 'error',
