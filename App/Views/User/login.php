...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/icons/login.svg" type="image/x-icon">
        ...
        <div class="row">
            <div class="col-11 col-sm-11 col-md-6 col-lg-6 text-light">
                ...
                <form>
                    ...
                    <button type="button" class="btn btn-success btn-block mt-4 mb-5 font-weight-bold btn-login">
                        Entrar
                    </button>
                </form>
                <hr>
                <div class="text-center">
                    <a href="register">
                        Não registrado(a)? Crie sua conta
                    </a>
                </div>
