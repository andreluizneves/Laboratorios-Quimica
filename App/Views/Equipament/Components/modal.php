    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12 col-12 text-center">
                <label class="font-weight-bold mt-1 mb-0" for="patrimony">
                    Número do Patrimônio
                </label>
                <input class="form-control text-center" id="patrimony" type="number" name="patrimony" value="<?= $data["patrimony"] ?>">
            </div>
            <div class="col-md-6 col-lg-6 col-sm-12 col-12">
        ...
        <input id="id" type="hidden" name="id" value="<?= $data["id_equipament"] ?>">
    </div>
