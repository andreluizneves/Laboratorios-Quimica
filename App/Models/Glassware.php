<?php
    ...
    class Glassware {
        /**
         * Método responsável por realizar seleções na tabela de Vidrarias.
        ...
        public static function Select(string $join = "", string $where = "", string $order = "", string $fields = "*", array $params = []) : PDOStatement {
            return (new Database("glassworks"))->Select($join, $where, $order, $fields, $params);
        }

        /**
         * Método responsável por realizar inserções na tabela de Vidrarias.
        ...
        public static function Insert(array $params) : int {
            return (new Database("glassworks"))->Insert($params);
        }

        /**
         * Método responsável por realizar atualizações na tabela de Vidrarias.
        ...
        public static function Update(string $where, array $values) : bool {
            return (new Database("glassworks"))->Update($where, $values);
        }

        /**
         * Método responsável por realizar exclusões na tabela de Vidrarias.
        ...
        public static function Delete(string $where, array $params) : bool {
            return (new Database("glassworks"))->Delete($where, $params);
        }
    }